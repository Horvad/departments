...
public class DTODepartmentCreate {
    ...
    public DTODepartmentCreate() {
    }

    public DTODepartmentCreate(String name, String phone, Long location_id, Long parent_id, List<Long> children_id) {
        this.name = name;
        this.phone = phone;
    ...
    public void addChildrenId(Long id){
        if(this.children_id==null){
            this.children_id = new ArrayList<>();
        }
        this.children_id.add(id);
    }
